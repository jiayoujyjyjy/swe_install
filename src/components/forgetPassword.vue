    ...
    <div class="content">
      <group>
        ...
        <x-input title="" v-model="code" placeholder="输入短信验证码" class="weui-vcode">
          ...
          <x-button slot="right" v-show="!passwordComputedTime" type="primary" mini  @click.native.prevent="phoneCheck">获取验证码</x-button>
